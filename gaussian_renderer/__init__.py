...
#
# also based on https://github.com/KeKsBoTer/c3dgs/blob/4b53a42863d66c22d128da24a7ac912bf5458f19/gaussian_renderer/__init__.py
import torch
import math
...
def render(
    ...
    rotations = None
    cov3D_precomp = None
    shs = pc._get_features_raw #TODO add that 
